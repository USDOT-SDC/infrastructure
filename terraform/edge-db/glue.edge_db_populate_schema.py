...
databaseName = get_runtime_param(run_properties,"databaseName")
tableName = get_runtime_param(run_properties,"tableName")
internalSchema = get_runtime_param(run_properties,"internalSchema")
